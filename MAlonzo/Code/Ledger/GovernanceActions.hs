...
d_GovVote_738 a0 = ()
data T_GovVote_738
  = C_GovVote'46'constructor_7125 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_gid_748 v0
  = case coe v0 of
      C_GovVote'46'constructor_7125 v1 v2 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_returnAddr_778 v0
  = case coe v0 of
      C_GovProposal'46'constructor_7513 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovProposal.anchor
d_anchor_780 :: T_GovProposal_756 -> T_Anchor_682
d_anchor_780 v0
  = case coe v0 of
      C_GovProposal'46'constructor_7513 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState
d_GovActionState_782 a0 = ()
data T_GovActionState_782
  = C_GovActionState'46'constructor_7879 MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
...
d_votes_794 v0
  = case coe v0 of
      C_GovActionState'46'constructor_7879 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_returnAddr_796 v0
  = case coe v0 of
      C_GovActionState'46'constructor_7879 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.expiresIn
d_expiresIn_798 :: T_GovActionState_782 -> AgdaAny
d_expiresIn_798 v0
  = case coe v0 of
      C_GovActionState'46'constructor_7879 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.action
d_action_800 :: T_GovActionState_782 -> T_GovAction_692
d_action_800 v0
  = case coe v0 of
      C_GovActionState'46'constructor_7879 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.GovernanceActions.GovActionState.prevAction
d_prevAction_802 :: T_GovActionState_782 -> AgdaAny
d_prevAction_802 v0
  = case coe v0 of
      C_GovActionState'46'constructor_7879 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_DecEq'45'Vote_806 ::
  MAlonzo.Code.Ledger.Types.GovStructure.T_GovStructure_6 ->
  MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
d_DecEq'45'Vote_806 ~v0 = du_DecEq'45'Vote_806
du_DecEq'45'Vote_806 :: MAlonzo.Code.Class.DecEq.Core.T_DecEq_10
du_DecEq'45'Vote_806
  = coe
      MAlonzo.Code.Class.DecEq.Core.C_DecEq'46'constructor_31
      (coe
         (\ v0 ->
                          ...
                          C_credVoter_676 v5 v6
                            -> coe
                                 ...
                                 (coe
                                    ...
                                    (coe
                                       MAlonzo.Code.Class.DecEq.Core.d__'8799'__16
                                       (coe du_DecEq'45'GovRole_804) v5 v2))
                                 (coe
                                    MAlonzo.Code.Function.Bundles.du_mk'8660'_2298 erased
                                    (coe
                                       (\ v7 ->
...
du_getDRepVote_810 v0
  = case coe v0 of
      C_GovVote'46'constructor_7125 v1 v2 v3 v4
        -> case coe v2 of
