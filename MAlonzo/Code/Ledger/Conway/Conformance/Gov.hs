...
du_certState_2114 v0
  = coe
      d_certState_2062 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
-- Ledger.Conway.Conformance.Gov._.enactState
d_enactState_2116 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_10001 ->
...
du_enactState_2116 ::
  T_GeneralizeTel_10001 -> MAlonzo.Code.Ledger.Enact.T_EnactState_826
du_enactState_2116 v0
  = coe
      d_enactState_2060 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
...
du_epoch_2118 :: T_GeneralizeTel_10001 -> AgdaAny
du_epoch_2118 v0
  = coe d_epoch_2054 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
...
du_pparams_2120 ::
  T_GeneralizeTel_10001 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_2120 v0
  = coe
      d_pparams_2056 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
...
du_ppolicy_2122 :: T_GeneralizeTel_10001 -> Maybe AgdaAny
du_ppolicy_2122 v0
  = coe
      d_ppolicy_2058 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
...
du_rewardCreds_2124 v0
  = coe
      d_rewardCreds_2064 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
...
du_txid_2126 :: T_GeneralizeTel_10001 -> AgdaAny
du_txid_2126 v0
  = coe d_txid_2052 (coe d_'46'generalizedField'45'Γ_9989 (coe v0))
-- Ledger.Conway.Conformance.Gov._.certState
d_certState_2136 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_Anchor_682 ->
  MAlonzo.Code.Ledger.Conway.Conformance.Certs.T_CertState_1070
...
du_certState_2136 v0
  = coe
      d_certState_2062 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
-- Ledger.Conway.Conformance.Gov._.enactState
d_enactState_2138 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
...
du_enactState_2138 ::
  T_GeneralizeTel_11095 -> MAlonzo.Code.Ledger.Enact.T_EnactState_826
du_enactState_2138 v0
  = coe
      d_enactState_2060 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
-- Ledger.Conway.Conformance.Gov._.epoch
d_epoch_2140 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
...
du_epoch_2140 :: T_GeneralizeTel_11095 -> AgdaAny
du_epoch_2140 v0
  = coe d_epoch_2054 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
-- Ledger.Conway.Conformance.Gov._.pparams
d_pparams_2142 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
...
du_pparams_2142 ::
  T_GeneralizeTel_11095 -> MAlonzo.Code.Ledger.PParams.T_PParams_242
du_pparams_2142 v0
  = coe
      d_pparams_2056 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
-- Ledger.Conway.Conformance.Gov._.ppolicy
d_ppolicy_2144 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
...
du_ppolicy_2144 :: T_GeneralizeTel_11095 -> Maybe AgdaAny
du_ppolicy_2144 v0
  = coe
      d_ppolicy_2058 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
-- Ledger.Conway.Conformance.Gov._.rewardCreds
d_rewardCreds_2146 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
...
du_rewardCreds_2146 v0
  = coe
      d_rewardCreds_2064 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
-- Ledger.Conway.Conformance.Gov._.txid
d_txid_2148 ::
  MAlonzo.Code.Ledger.Transaction.T_TransactionStructure_20 ->
  T_GeneralizeTel_11095 ->
...
du_txid_2148 :: T_GeneralizeTel_11095 -> AgdaAny
du_txid_2148 v0
  = coe d_txid_2052 (coe d_'46'generalizedField'45'Γ_11079 (coe v0))
...
du_govActionDeposit_2174 :: T_GeneralizeTel_11095 -> Integer
...
du_govActionLifetime_2176 :: T_GeneralizeTel_11095 -> Integer
...
d_'46'generalizedField'45'Γ_9989 ::
  T_GeneralizeTel_10001 -> T_GovEnv_2036
d_'46'generalizedField'45'Γ_9989 v0
  = case coe v0 of
      C_mkGeneralizeTel_10003 v1 v2 v3 v4 v5 v6 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-aid
d_'46'generalizedField'45'aid_9991 ::
  T_GeneralizeTel_10001 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'aid_9991 v0
  = case coe v0 of
      C_mkGeneralizeTel_10003 v1 v2 v3 v4 v5 v6 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-voter
d_'46'generalizedField'45'voter_9993 ::
  T_GeneralizeTel_10001 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_'46'generalizedField'45'voter_9993 v0
  = case coe v0 of
      C_mkGeneralizeTel_10003 v1 v2 v3 v4 v5 v6 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-v
d_'46'generalizedField'45'v_9995 ::
  T_GeneralizeTel_10001 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_Vote_714
d_'46'generalizedField'45'v_9995 v0
  = case coe v0 of
      C_mkGeneralizeTel_10003 v1 v2 v3 v4 v5 v6 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-s
d_'46'generalizedField'45's_9997 ::
  T_GeneralizeTel_10001 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45's_9997 v0
  = case coe v0 of
      C_mkGeneralizeTel_10003 v1 v2 v3 v4 v5 v6 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-k
d_'46'generalizedField'45'k_9999 ::
  T_GeneralizeTel_10001 -> Integer
d_'46'generalizedField'45'k_9999 v0
  = case coe v0 of
      C_mkGeneralizeTel_10003 v1 v2 v3 v4 v5 v6 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GeneralizeTel
d_GeneralizeTel_10001 a0 = ()
data T_GeneralizeTel_10001
  = C_mkGeneralizeTel_10003 T_GovEnv_2036
                            MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                            MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
                            MAlonzo.Code.Ledger.GovernanceActions.T_Vote_714
                            [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14] Integer
-- Ledger.Conway.Conformance.Gov..generalizedField-Γ
d_'46'generalizedField'45'Γ_11079 ::
  T_GeneralizeTel_11095 -> T_GovEnv_2036
d_'46'generalizedField'45'Γ_11079 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-addr
d_'46'generalizedField'45'addr_11081 ::
  T_GeneralizeTel_11095 -> MAlonzo.Code.Ledger.Address.T_RwdAddr_76
d_'46'generalizedField'45'addr_11081 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-a
d_'46'generalizedField'45'a_11083 ::
  T_GeneralizeTel_11095 ->
  MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_692
d_'46'generalizedField'45'a_11083 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-p
d_'46'generalizedField'45'p_11085 ::
  T_GeneralizeTel_11095 -> Maybe AgdaAny
d_'46'generalizedField'45'p_11085 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-d
d_'46'generalizedField'45'd_11087 ::
  T_GeneralizeTel_11095 -> Integer
d_'46'generalizedField'45'd_11087 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-prev
d_'46'generalizedField'45'prev_11089 ::
  T_GeneralizeTel_11095 -> AgdaAny
d_'46'generalizedField'45'prev_11089 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-s
d_'46'generalizedField'45's_11091 ::
  T_GeneralizeTel_11095 -> [MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14]
d_'46'generalizedField'45's_11091 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov..generalizedField-k
d_'46'generalizedField'45'k_11093 ::
  T_GeneralizeTel_11095 -> Integer
d_'46'generalizedField'45'k_11093 v0
  = case coe v0 of
      C_mkGeneralizeTel_11097 v1 v2 v3 v4 v5 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Ledger.Conway.Conformance.Gov.GeneralizeTel
d_GeneralizeTel_11095 a0 = ()
data T_GeneralizeTel_11095
  = C_mkGeneralizeTel_11097 T_GovEnv_2036
                            MAlonzo.Code.Ledger.Address.T_RwdAddr_76
                            MAlonzo.Code.Ledger.GovernanceActions.T_GovAction_692
